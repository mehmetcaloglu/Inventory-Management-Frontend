...
type EditItemProps = {
  item: IProduct;
  handleUpdateItem: ( updatedItem: IProduct ) => void;
  open: boolean;
  toggleModal: () => void;
...
{
  const [ updatedItem, setUpdatedItem ] = useState<IProduct>( item );
  ...
  useEffect( () =>
  {
    const validateForm = () =>
    {
      ...
      const { description, name, price, quantity, category } = updatedItem;
      ...
      if ( !description ) {
        ...
        newErrors.description = 'Description must have between 10 to 255  characters';
      }
                ...
                <div className="max-w-md max-auto">
                  <div>
                    ...
                    <div className="my-4">
                      ...
                      { errors.description && <div className="text-xs alert-danger text-error">{ errors.description }</div> }
                    </div>
                    <div className="my-4">
                      <label
                        className="block text-sm font-medium text-gray-500"
